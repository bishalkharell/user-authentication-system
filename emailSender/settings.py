...
SECRET_KEY = '$k!+^7v=51f2_&hxadhv%u)-0r7lsy^tc-v9*mawq_(*02)!4!'
...
STATIC_URL = '/static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR,'auth_users/static')
]
...
EMAIL_PORT = HOST EMAIL PORT HERE
EMAIL_HOST_USER = 'FROM: your email '
